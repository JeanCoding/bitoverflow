    ...
    <div class='flex'>
        <div class='hidden lg:block'>
                <aside class='text-white font-bold' style='width: 175px; font-family: Laro'>
                    ...
                    <a href='home.php'><button class='pl-3 flex items-center my-2'><img src='icons/house.svg' class='pr-2'>Home</button></a>
        ...
        <div class='mt-6 lg:mt-0 bg-neutral-700 text-white py-8 px-7 rounded-3xl flex w-full' style='box-shadow: 0px 4px 40px 2px rgba(0, 0, 0, 0.25);'>
